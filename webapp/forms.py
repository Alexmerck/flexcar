...
class CarinputForm(FlaskForm):
    ...
    manufacturer = SelectField('Введите произовдителя авто (максимум 100 символов)', validators=[DataRequired()],  render_kw={"class":"form-control"})
    model = SelectField('Введите модель авто (максимум 100 символов)', validators=[DataRequired()], render_kw={"class":"form-control"})
